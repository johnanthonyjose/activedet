...
from activedet.evaluation import CustomPascalVOCDetectionEvaluator

from .pascal_voc import dataloader
...
dataloader.evaluator = L(CustomPascalVOCDetectionEvaluator)(
