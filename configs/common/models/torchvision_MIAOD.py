...
from detectron2.modeling.backbone import BasicStem, ResNet, FPN
from detectron2.modeling.box_regression import Box2BoxTransform
from detectron2.modeling.matcher import Matcher
from activedet.modeling.meta_arch import MIAOD, AODHead
from .MIAOD import model

model = L(MIAOD)(
    backbone=L(FPN)(
        bottom_up=L(ResNet)(
            stem=L(BasicStem)(in_channels=3, out_channels=64, norm="SyncBN"),
